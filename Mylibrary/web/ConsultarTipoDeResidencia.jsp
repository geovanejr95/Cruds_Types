...
<html>
<head>
    <title>Consulta Tipo de Residencia</title>
</head>
<body>
<%
...
<section>
    <article>
        <form action="TypeHouse" method="post">
            <fieldset>
                ...
                <div>
                    <input type="submit" formaction="InserirTipoDeResidencia.jsp" value="Cadastrar">
    ...
    <article>
        <table>
            <thead>
            <tr>
                <th colspan="4"><h3>Tipos de Residencia cadastrados!</h3></th>
            </tr>
            <tr>
                <th>#ID</th>
                <th>Tipo</th>
                ...
                if (objResult != null) {
                    ...
                    if (objEntities != null) {
                        for (cEntityDomain objED : objEntities) {
                            cTypeHouse objTH = (cTypeHouse) objED;

                            criaTabela.append("<tr>");
                            criaTabela.append("<td>");
                            criaTabela.append(objTH.getId());
                            criaTabela.append("</td>");
                            criaTabela.append("<td>");
                            criaTabela.append(objTH.getType());
                            criaTabela.append("</td>");
                            criaTabela.append("<td>");
                            if (objTH.isActive()) {
                            ...
                            criaTabela.append("</td>");
                            criaTabela.append("<td>");
                            criaTabela.append("<a href='TypeHouse?txtId=").append(objTH.getId()).append("&operation=Visualizar'><button type='button' class='btn btn-success'>Visualizar</button></a>");
                            criaTabela.append("</td>");
                            criaTabela.append("</tr>");
